...
# Данный скрипт создает виртуальное окружение и запускает программу для шифрования информации и дальнейшего
# ее встраивания (стеганографии) в файловую систему.
