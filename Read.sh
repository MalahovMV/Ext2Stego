...
# Данный скрипт создает виртуальное окружение и запускает программу для считывания
# вкрапленной информации из файловой системы.
# После выполнения удаляются все временные файлы
